...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterWideScope) DeepCopyInto(out *ClusterWideScope) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterWideScope.
func (in *ClusterWideScope) DeepCopy() *ClusterWideScope {
	if in == nil {
		return nil
	}
	out := new(ClusterWideScope)
	in.DeepCopyInto(out)
	return out
}
